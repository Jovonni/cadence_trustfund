...
transaction {
  prepare(acct: AuthAccount) {
    ...
    //
    acct.link<&FlowToken.Vault{FlowToken.Receiver, FlowToken.Balance}>(/public/MainReceiver, target: /storage/MainVault)
  ...
  post {
    ...
    getAccount(0x01).getCapability<&FlowToken.Vault{FlowToken.Receiver}>(/public/MainReceiver)
                    .check():
